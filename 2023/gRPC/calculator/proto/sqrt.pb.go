...
type SqrtRequest struct {
	...
	Number float64 `protobuf:"fixed64,1,opt,name=number,proto3" json:"number,omitempty"` // could be uint but we want to make negative sqrt to fail
}
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x6c, 0x73, 0x6b, 0x79, 0x2f, 0x67, 0x6f, 0x65, 0x73, 0x2f, 0x32, 0x30, 0x32, 0x33, 0x2f, 0x67,
